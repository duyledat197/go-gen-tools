...
// Validate checks the field values on AddUsersToTeamRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *AddUsersToTeamRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AddUsersToTeamRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AddUsersToTeamRequestMultiError, or nil if none found.
func (m *AddUsersToTeamRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *AddUsersToTeamRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// AddUsersToTeamRequestMultiError is an error wrapping multiple validation
// errors returned by AddUsersToTeamRequest.ValidateAll() if the designated
// constraints aren't met.
type AddUsersToTeamRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AddUsersToTeamRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AddUsersToTeamRequestMultiError) AllErrors() []error { return m }

// AddUsersToTeamRequestValidationError is the validation error returned by
// AddUsersToTeamRequest.Validate if the designated constraints aren't met.
type AddUsersToTeamRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AddUsersToTeamRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AddUsersToTeamRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AddUsersToTeamRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AddUsersToTeamRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AddUsersToTeamRequestValidationError) ErrorName() string {
	return "AddUsersToTeamRequestValidationError"
}

// Error satisfies the builtin error interface
func (e AddUsersToTeamRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAddUsersToTeamRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AddUsersToTeamRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AddUsersToTeamRequestValidationError{}

// Validate checks the field values on AddUsersToTeamResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *AddUsersToTeamResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AddUsersToTeamResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AddUsersToTeamResponseMultiError, or nil if none found.
func (m *AddUsersToTeamResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *AddUsersToTeamResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// AddUsersToTeamResponseMultiError is an error wrapping multiple validation
// errors returned by AddUsersToTeamResponse.ValidateAll() if the designated
// constraints aren't met.
type AddUsersToTeamResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AddUsersToTeamResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AddUsersToTeamResponseMultiError) AllErrors() []error { return m }

// AddUsersToTeamResponseValidationError is the validation error returned by
// AddUsersToTeamResponse.Validate if the designated constraints aren't met.
type AddUsersToTeamResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AddUsersToTeamResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AddUsersToTeamResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AddUsersToTeamResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AddUsersToTeamResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AddUsersToTeamResponseValidationError) ErrorName() string {
	return "AddUsersToTeamResponseValidationError"
}

// Error satisfies the builtin error interface
func (e AddUsersToTeamResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAddUsersToTeamResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AddUsersToTeamResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AddUsersToTeamResponseValidationError{}
